...
?>
  ...
  <div class="table-responsive">
    <?php
        $query = "SELECT * FROM police_emergency  WHERE state = 'rajasthan' ";
   ...
   <div class="table-responsive">
    <?php
        $query = "SELECT * FROM ambulance_emergency  WHERE state = 'rajasthan' ";
        $query_run = mysqli_query($connection, $query);
    ?>
<!-- /.container-fluid -->
 ...
 <div class="table-responsive">
    <?php
        $query = "SELECT * FROM fire_emergency  WHERE state = 'rajasthan' ";
        $query_run = mysqli_query($connection, $query);
    ?>
      <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
        <thead>
