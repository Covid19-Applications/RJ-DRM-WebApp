                ...
                <div class="col-lg-6">
                    <div class="bradcam_text">
                        ...
                        <h1>Covid Care Centers</h1>
                            <p>ESIC MODEL HOSPITAL</p>
                            <p>The government of India has announced on 17th May that the containment zones and buffer zones shall be demarcated by the district authorities, after taking into consideration the guidelines of MoHFW.</p>
      ...
      <div class="container  text-center">
        ...
        <div class="row col-lg-12">
          ...
          <div class="col-lg-4 " data-aos="zoom-in" data-aos-delay="100">
            <h4><a href="https://covidindia.org/rajasthan/">Isolation Centers</h4></a> 
          </div>

          <div class="col-lg-4 " data-aos="zoom-in" data-aos-delay="100">
            <h4><a href="https://covidindia.org/rajasthan/">Quarantine Centers</h4></a> 
          </div>

          <div class="col-lg-4 " data-aos="zoom-in" data-aos-delay="100">
            <h4><a href="covid-dashboard.php #testing">Testing Centers</h4></a> 
    ...
    <!-- Start Align Area -->
     ...
     <div class="whole-wrap">
        <div class="container box_1170">
            <div class="col-lg-12">
                     <h2 class="title-1 m-b-25" id="iso" >Covid19 Health Care Centers In Rajasthan</h2>
   ...
   <script type="text/javascript">
    ...
    success : function(covid_data) {
     ...
     var newArray = covid_data.records.filter(function (el) {
      ...
      return el.state_name === 'Rajasthan';
