  ...
  background-color: #FFC7C9;
	...
	<div class="whole-wrap">
		<div class="container box_1170">
			...
			<div class="col-lg-12">
                                <h2 class="title-1 m-b-25">Hospitals In Rajasthan</h2>
                                <div class="table-responsive table--no-card m-b-40">
                                    <?php
                                                  $query = "SELECT * FROM hospitals WHERE state = 'rajasthan' ";
